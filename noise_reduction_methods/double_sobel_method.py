...
class DoubleSobelMethod():
    ...
    def set_current_pixel(self , pixel):
        mask_sobel_vertical.set_current_pixel(pixel)
        mask_sobel_horizontal.set_current_pixel(pixel)
    
    def get_transformed_pixel(self):
        vertical_sobel_pixel =  mask_sobel_vertical.get_transformed_pixel()
        horizontal_sobel_pixel = mask_sobel_horizontal.get_transformed_pixel()
